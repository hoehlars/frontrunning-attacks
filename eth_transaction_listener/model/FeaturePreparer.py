...
class FeaturePreparer:
    def __init__(self, web3, etherscan_api_key):
        ...
        self.mean_feature_7 = torch.load('./model/feature_7_model/mean_train.pt', map_location='cpu')
        self.std_feature_7 = torch.load('./model/feature_7_model/std_train.pt', map_location='cpu')
